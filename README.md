...
Test start_ITS.sh by running it. ./start_ITS.sh While it’s running, it will make the Imlac terminal window active. Don’t change focus away from it, or it will likely fail. Wait until you’re in the maze before touching anything.
